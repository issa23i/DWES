...
--
-- Servidor: localhost
-- Tiempo de generación: 30-12-2022 a las 15:50:31
...
INSERT INTO `pedidos` (`codped`, `fecha`, `usuario`, `coste`) VALUES
(123, '2022-01-09 17:34:29', 'dwes', '1286.40'),
(124, '2022-01-09 17:37:11', 'dwes', '2825.40');
...
CREATE TABLE `pedidosproductos` (
  ...
  `codped` int(11) NOT NULL,
  `codprod` varchar(12) COLLATE utf8_spanish_ci NOT NULL,
...
(113, 123, 'IXUS115HSAZ', 3),
(114, 123, 'PAPYRE62GB', 1),
(115, 123, 'EEEPC1005PXD', 2),
(116, 124, 'LEGRIAFS306', 2),
(117, 124, 'PBELLI810323', 3),
(118, 124, 'SMSGCLX3175', 1);
...
CREATE TABLE `sobremesa` (
  `cod` varchar(12) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `marca` varchar(24) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `modelo` varchar(24) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `procesador` varchar(16) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `ram` varchar(9) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `rom` varchar(9) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `extras` varchar(24) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL
...
INSERT INTO `sobremesa` (`cod`, `marca`, `modelo`, `procesador`, `ram`, `rom`, `extras`) VALUES
('ACERAX3950', 'Packard Bell', 'I5650pro', 'i5-650', '8GB', '1 TB', 'Grabadora DVD');
...
CREATE TABLE `televisor` (
  ...
  `panel` varchar(50) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `televisor` (`cod`, `pulgadas`, `resolucion`, `panel`) VALUES
('BRAVIA2BX400', 32, '1920x1080', 'TFT'),
('LGM237WDP', 23, '1920x1080', 'TFT-LCD TN');
...
('ana', '276b6c4692e78d4799c12ada515bc3e4'),
('dwes', 'e8dc8ccd5e5f9e3a54f07350ce8a2d3d'),
('eva', '14bd76e02198410c078ab65227ea0794'),
('isa', '165a1761634db1e9bd304ea6f3ffcf2b'),
...
--
ALTER TABLE `pedidos`
  MODIFY `codped` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=127;

--
-- AUTO_INCREMENT de la tabla `pedidosproductos`
--
ALTER TABLE `pedidosproductos`
  MODIFY `codpedprod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
...
ALTER TABLE `pedidosproductos`
  ...
  ADD CONSTRAINT `pedidosproductos_ibfk_2` FOREIGN KEY (`codprod`) REFERENCES `producto` (`cod`);
...
--
-- Filtros para la tabla `sobremesa`
--
ALTER TABLE `sobremesa`
  ADD CONSTRAINT `sobremesa_ibfk_1` FOREIGN KEY (`cod`) REFERENCES `producto` (`cod`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `televisor`
--
ALTER TABLE `televisor`
  ADD CONSTRAINT `televisor_ibfk_1` FOREIGN KEY (`cod`) REFERENCES `producto` (`cod`) ON UPDATE CASCADE;
COMMIT;
